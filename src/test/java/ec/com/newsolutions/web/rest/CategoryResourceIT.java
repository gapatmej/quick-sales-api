...
public class CategoryResourceIT {
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.isPredetermined()).isEqualTo(DEFAULT_PREDETERMINED);
    ...
    public void checkPredeterminedIsRequired() throws Exception {
        ...
        // set the field null
        category.setPredetermined(null);
    ...
    public void updateCategory() throws Exception {
        ...
        Category testCategory = categoryList.get(categoryList.size() - 1);
        assertThat(testCategory.isPredetermined()).isEqualTo(UPDATED_PREDETERMINED);
